...
class TemplateHelper(object):
    ...
    def __init__(self, plugin_manager, user_manager, use_minified=True):
        ...
        self._base_helpers = {"header_hook": (lambda **kwargs: self._generic_hook('header_html', **kwargs)),
                              ...
                              "submission_query_header": (lambda **kwargs: self._generic_hook('submission_query_header', **kwargs)),
                              "submission_query_cell": (lambda **kwargs: self._generic_hook('submission_query_cell', **kwargs)),
                              "submission_query_button": (lambda **kwargs: self._generic_hook('submission_query_button', **kwargs)),
                              "task_list_bar_label": (lambda **kwargs: self._generic_hook('task_list_bar_label', **kwargs)),
